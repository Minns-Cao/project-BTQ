...
let mainCustomerPage = document.querySelector(".mainCustomerPage");
list_boxCustomer.forEach((boxCustomer) => {
    boxCustomer.addEventListener("click", () => {
        ...
        mainCustomerPage.classList.add("active");
...
function activeIconMenuBar(x) {
    if (CompanyPage_status === "close") {
        ...
        mainCustomerPage.classList.remove("active");
...
list_touchPoint.forEach((touchPoint) => {
    ...
    touchPoint.addEventListener("mouseleave", (e) => {
...
// ======================SlideCustomer=========================
setInterval(() => {
    let list_logoPic = document.querySelectorAll(".logoPic");
    // console.log(list_logoPic.length);
    if (list_logoPic.length > 0) {
        document
            .querySelector(".contentBlock3 .slide")
            .appendChild(list_logoPic[0]);
    }
}, 5000);
...
function showLoading(event) {
    ...
    let loading = document.querySelector(".overlayLoading");
