...
btnEnter.addEventListener("mousemove", (e) => {
    let rectEvent =  e.getBoundingClientRect();
    console.log(rectEvent.top);
    console.log(rectEvent.bottom);
    let rectOfBtnEnter = btnEnter.getBoundingClientRect();
    yValue = rectOfBtnEnter.top + rectOfBtnEnter.height / 2;
    xValue = rectOfBtnEnter.left + rectOfBtnEnter.width / 2;
    console.log(xValue)
});
