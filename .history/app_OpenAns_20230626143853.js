...
function ScrollAnimation(elm, distance, speed) {
    ...
    let pixelsPerSecond = speed * 1000;
...
let element = document.querySelector('.contentBlock2 .contentBox'); // Thay 'yourElementId' bằng id của phần tử bạn muốn thực hiện animation
let distanceToMove = 400; // Khoảng đường di chuyển tối đa của phần tử (theo trục Y)
let animationSpeed = 0.0001; // Tốc độ di chuyển của phần tử
