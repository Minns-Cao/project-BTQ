...
function showImgWrap() {
    setTimeout(() => {
        ...
        let elm = document.querySelector(".slide-img-4");
        const styles = window.getComputedStyle(elm);
        const currentAnimation = styles.animationName;
        console.log(styles.animationName);
...
//     return currentAnimation !== "none" && currentAnimation === animationName;
// }

// // Sử dụng hàm isAnimationRunning() để kiểm tra trạng thái của animation
