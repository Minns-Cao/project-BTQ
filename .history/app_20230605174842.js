...
function showImgWrap() {
    ...
    let last_animationElm = document.querySelector(".show_img4");
    let stylesOfLastAnimationElm = window.getComputedStyle(last_animationElm);
    console.log(stylesOfLastAnimationElm.animationDelay);
    setTimeout(() => {
