...
let textBtnEnter = btnEnter.document.querySelector(".text");
btnEnter.addEventListener("mousemove", (e) => {
    ...
    let speed = 0.25;
    btnEnter.style.transform = `translate(${(xValue - xValueBtn) * speed - 50}%,${
        (yValue - yValueBtn) * speed - 50
    }%) scale(1.3)`;
    console.log(textBtnEnter.style.fontSize);
    textBtnEnter.style.fontSize = `22.3px`
