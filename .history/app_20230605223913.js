...
function remove_animationChar_hide() {
    ...
    let array_allChar = document.querySelectorAll(".char");
    let notArray = Array.from(list_allChar).filter(elm => !Array.from(list_firstSlideChar).contains(elm));
    // console.log(Array.from(list_allChar));
    // console.log(list_firstSlideChar)
