...
const element = document.querySelector('.contentBlock2 .contentBox'); // Thay 'yourElementId' bằng id của phần tử bạn muốn thực hiện animation
const distanceToMove = 200; // Khoảng đường di chuyển tối đa của phần tử (theo trục Y)
const animationSpeed = 0.5; // Tốc độ di chuyển của phần tử
