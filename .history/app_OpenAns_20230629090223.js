...
// =====================ScrollAnimation=========================
function ScrollAnimation(elm, distance, speed, trend = "down") {
    window.addEventListener("scroll", function (trend = "down") {
        //khoảng di chuyển
...
ScrollAnimation(
    document.querySelector(".contentBlock4 .contentBox"),
    120,
    0.2,
    "up"
);
