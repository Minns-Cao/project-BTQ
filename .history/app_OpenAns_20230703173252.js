...
window.addEventListener("load", () => {
    ...
    // iframeImg1 = bodySubPage.querySelector('.imgFirst');
});
...
function changeContent(elm){
    ...
    console.log(img1,img2,img3,name,label);
    let iframeImg1 = iframeImg1 = bodySubPage.querySelector('.imgFirst');
    console.log(bodySubPage);
    console.log(iframeImg1);
}
