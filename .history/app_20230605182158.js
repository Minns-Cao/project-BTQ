...
function showImgWrap() {
    ...
    setTimeout(() => {
        ...
        changeBackround();
        document.querySelector(".slide-img-1").classList.add("pic-img-show");
        document.querySelector(".slide-img-2").classList.add("pic-img-show");
        document.querySelector(".slide-img-3").classList.add("pic-img-show");
        document.querySelector(".slide-img-4").classList.add(".pic-img-show");
